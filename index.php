...
<section class="banner-area">
    <div class="container">
        <div class="main-banner-content">
            <img src="assets/img/crown.svg" style="height: 30px;" alt="">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-featured-services-box">
                    ...
                    <h3><a href="#">Business Planing</a></h3>
                    <p>We provide ideas to make your business success, We will help you to improve performance and
                        state in the coming period.</p>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-featured-services-box">
                    ...
                    <h3><a href="single-services.html">Web Development</a></h3>
                    <p>We develop full-stack web applications for any kind of requirements. We can craft your ideas
                        to a reality.</p>
                    <a href="single-services.html" class="learn-more-btn"><i class="left-icon flaticon-next-button"></i>
                        Learn More <i class="right-icon flaticon-next-button"></i></a>
                </div>
            </div>
            <!--Single Service Box-->
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-0 offset-md-3 offset-sm-3">
                <div class="single-featured-services-box">
                    ...
                    <h3><a href="single-services.html">SEO Optimization</a></h3>
                    <p>We give you the best SEO Optimizing Service to improve your website's. This will help to make
                        your website more accessible for clients.</p>
                    <a href="single-services.html" class="learn-more-btn"><i class="left-icon flaticon-next-button"></i>
                        Learn More <i class="right-icon flaticon-next-button"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="about-content">
                    <div class="text">
                        ...
                        <h2>Meet Full-Stack Software Developing Expertise</h2>
...
<!-- Start Services Area -->
<section class="services-area bg-f9f9f9 pt-100 pb-70" id="services">
    <div class="container">
        <div class="section-title">
            <span class="sub-title">Services</span>
            <h2>Let’s Check Our Services</h2>
            <p>The best quality customer service with 24/7 reachability.</p>
        </div>

        <div class="row">
            <!--TODO: Have to write the content-->
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-services-box">
                    ...
                    <h3><a href="#">Web Hosting & Maintain</a></h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                        labore et dolore magna.</p>
                    <a href="#" class="learn-more-btn"><i class="left-icon flaticon-next-button"></i>
                        Learn More <i class="right-icon flaticon-next-button"></i></a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-services-box">
                    ...
                    <h3><a href="#">Database Solutions</a></h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                        labore et dolore magna.</p>
                    <a href="#" class="learn-more-btn"><i class="left-icon flaticon-next-button"></i>
                        Learn More <i class="right-icon flaticon-next-button"></i></a>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12">
                <div class="what-we-do-content">
                    ...
                    <div class="skills-item">
                        <div class="skills-header">
                            <h4 class="skills-title">Graphic Design</h4>
                            <div class="skills-percentage">
                                <div class="count-box">65%</div>
                            </div>
                        </div>
                        <div class="skills-bar">
                            <div class="bar-inner">
    ...
    <div class="container">
        ...
        <div class="team-slides owl-carousel owl-theme">
            <div class="single-team-member">
                <div class="image">
                    <img src="assets/img/team/buddhika.jpg" alt="team-image">

                    <ul class="social-link">
                        <li><a href="https://www.facebook.com/profile.php?id=100071182010757" class="d-block"
                               target="_blank"><i class='bx bxl-facebook'></i></a></li>
                        <li><a href="https://www.linkedin.com/in/buddhika-viraj-801469202/" class="d-block"
                               target="_blank"><i class='bx bxl-linkedin'></i></a></li>
                    </ul>
                </div>

                <div class="content">
                    <h3>Buddhika Viraj</h3>
                    <span>Developer</span>
            ...
            <div class="single-team-member">
                <div class="image">
                    <img src="assets/img/team/menuka.jpg" alt="team-image">
            ...
            <div class="single-team-member">
                <div class="image">
                    <img src="assets/img/team/poojitha.jpg" alt="team-image">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="project-start-content">
                    ...
                    <p>Our company provides the best software solution.
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    ...
                    <p>Our company provides the best software solution. As a company we have trustworthy, flexible,
                        creative, skillful, professional team to resolve challenges and to give new life to client
                        requirments</p>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    ...
                    <ul class="footer-contact-info">
                        <li><i class='bx bx-map'></i>24/7 Online Service</li>
                        <li><i class='bx bx-phone-call'></i><a href="tel:+94702709061">+94 70 270 9061</a></li>
                        <li><i class='bx bx-envelope'></i><a href="mailto:softwaresolutionsbmp@gmail.com">softwaresolutionsbmp@gmail.com</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="footer-bottom-area">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <p>2022 © <span style="color: #ffb601;">BMP Software Solutions</span> Pvt Ltd.</a></p>
                </div>
